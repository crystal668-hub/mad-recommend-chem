        ...
        *,
        ...
        if self.llm is None:
            raise PeerReviewExecutionError(
                stage="methodology_reviewer_startup",
                message="Methodology reviewer LLM is unavailable.",
                reviewer_type=self.reviewer_type,
                claim_id=claim.claim_id,
                review_round=review_round,
            )
        ...
        try:
            ...
            raise PeerReviewExecutionError(
                stage="methodology_reviewer_invoke",
                message="Methodology reviewer LLM call failed.",
        ...
        if not isinstance(parsed, dict):
            raise PeerReviewExecutionError(
                stage="methodology_reviewer_invalid_response",
                message="Methodology reviewer returned a non-object payload.",
                reviewer_type=self.reviewer_type,
                claim_id=claim.claim_id,
                review_round=review_round,
